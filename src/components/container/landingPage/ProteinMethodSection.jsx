        ...
        <Container className="grid gap-8 md:grid-cols-[1fr_1.1fr]">
          ...
          <div className="rounded-3xl ">
            ...
            <div className="relative mt-10 overflow-hidden rounded-3xl p-5 lg:py-8 lg:px-16 lg:pb-20 text-black">
              <div className='absolute z-10 top-4 right-4 lg:top-0 lg:right-4 border-21 h-22 w-22 flex items-center justify-center rounded-full border-black bg-primary p-[0.3px]'>
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="pointer-events-none absolute s lg:hidden inset-0 z-0 h-full w-full"
                preserveAspectRatio="none"
                aria-hidden="true"
                focusable="false"
              >
